...
export default class RecipeDetails extends Component {
    ...
    //     this.state = {
    //         recipe: recipe,
    //         url: `https://www.food2fork.com/api/get?key=78090af3b54970f84e001ec7a3282f6b&rId=${this.props.id}`
    //     }
    // }
    ...
    //     }
    // }
    // ** one other way to do the same thing ** 
    state = {
        recipe: recipe
    }
    ...
    async componentDidMount() {
        ...
        const url = `https://www.food2fork.com/api/get?key=78090af3b54970f84e001ec7a3282f6b&rId=${id}`;
        try {
